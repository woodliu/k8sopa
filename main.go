...
import (
	...
	"github.com/woodliu/k8sopa/pkg/webhook"
	"gopkg.in/yaml.v3"
...
func main() {
	...
	client := client.StartConstraintTmplInformer(host, token)
	defer client.StopConstraintTmplInformer()
